...
def enhance_with_llm_rag(query, content):
    ...
    messages = [
        ...
        If the content only contains 'No matches found', only then add this message at the end: "This query has been updated in the Knowledge Gap Tracker page in Confluence - https://engineeringonboarding.atlassian.net/wiki/spaces/SD/pages/9240675/Knowledge+Gap+Tracker" """
        ),
